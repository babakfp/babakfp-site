...
<div class="max-w-prose mx-auto">
	...
	<div class="mt-4 flex flex-wrap gap-4">
		...
		<Link href="https://dribbble.com/babakfp">
			<!-- prettier-ignore -->
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4.5 h-4.5 fill-gray-400" aria-hidden="true">
		...
		<button
			class="group relative inline-flex gap-2 py-2 px-3 pr-4 rounded text-sm bg-gray-800/50 backdrop-blur highlight-white/5 select-none duration-150 hover:bg-gray-700/50"
