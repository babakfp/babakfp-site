<script>
	...
	const wordpressPlugins = [
		...
		},
		{
			...
			description: 'Adds the functionality to easily use a Persian font in the Elementor Page Builder plugin.',
	...
	const rtlThemeProducts = [
		{
			...
			description: 'A Wordpress plugin to build fullpage scrollable sections with Elementor Page Builder.',
			href: 'https://www.rtl-theme.com/pixerul-wordpress-plugin',
			thumb: 'https://files.rtl-theme.com/attachments/2022/01/6a61ed2f8328c890731182a647624375268847d0b43620-160x160.png',
			sales: 112,
			rating: 4.5,
			reviewsCount: 15,
		},
		{
			...
			thumb: 'https://files.rtl-theme.com/attachments/2022/02/c6f8a685d11b7802d1b380775763a4697385e842bde6d7-160x160.png',
			sales: 6,
			rating: null,
			reviewsCount: 0,
		},
