						...
						<li>
							...
							>
								...
								>
									{#if title === "GitHub"}
										<!-- prettier-ignore -->
										<svg class="text-base text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
									...
									{:else if title === "NPM"}
										<!-- prettier-ignore -->
										<svg class="text-base text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
											<path d="M288 288h-32v-64h32v64zm288-128v192H288v32H160v-32H0V160h576zm-416 32H32v128h64v-96h32v96h32V192zm160 0H192v160h64v-32h64V192zm224 0H352v128h64v-96h32v96h32v-96h32v96h32V192z"/>
										</svg>
									{:else if title === "Demo"}
										<!-- prettier-ignore -->
										<svg class="text-2xl" aria-hidden="true" fill="none" viewBox="0 0 24 24">
											<path class="fill-gray-600" d="M4 12a7 7 0 0 1 7-7h2a7 7 0 1 1 0 14h-2a7 7 0 0 1-7-7Z"></path>
											<path class="stroke-gray-300" d="M10.25 9.75 7.75 12l2.5 2.25"></path>
											<path class="stroke-gray-300" d="m13.75 9.75 2.5 2.25-2.5 2.25"></path>
										</svg>
									{/if}
								</div>
