				...
				<ul class="mt-12 font-mono">
					{#each project.primaryLinks as { href, title, isExternal }}
						<li>
							...
							>
								<div
									class="flex items-center justify-center w-7 h-7 bg-white/5 rounded-[.375rem] duration-150 group-hover:bg-white/10"
								>
									{#if title === "GitHub"}
										<!-- prettier-ignore -->
										<svg class="w-4 h-4 fill-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
									...
									{:else if title === "NPM"}
										<!-- prettier-ignore -->
										<svg class="w-4 h-4 fill-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
											<path d="M288 288h-32v-64h32v64zm288-128v192H288v32H160v-32H0V160h576zm-416 32H32v128h64v-96h32v96h32V192zm160 0H192v160h64v-32h64V192zm224 0H352v128h64v-96h32v96h32v-96h32v96h32V192z"/>
										</svg>
									{:else}
										<!-- prettier-ignore -->
										<svg class="fill-none" viewBox="0 0 24 24">
											<path d="M10.25 9.75 7.75 12l2.5 2.25" class="stroke-gray-300"/>
											<path d="m13.75 9.75 2.5 2.25-2.5 2.25" class="stroke-gray-300"/>
										</svg>
									{/if}
								</div>
